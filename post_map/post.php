...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="assets/css/mapbbs.css" />
          ...
          ================================================== -->
                ...
                <div class="hero row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h1><a href="https://www.youtube.com" target="_blank"><img src="logo/yt_logo.png" width="200" height="40"></a></h1>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8 webscope">
                        ...
                        <a href=""> <img src="logo/logo04.png"/> </a>
                    </div>
                    <!--webscope-->
            ...
            function initialize() {
                ...
                google.maps.event.addListener(map, 'click',
                    function(event) {
                        ...
                        //クリックで出現するマーカー設定
                        var icon = new google.maps.MarkerImage('click_icon.png',
